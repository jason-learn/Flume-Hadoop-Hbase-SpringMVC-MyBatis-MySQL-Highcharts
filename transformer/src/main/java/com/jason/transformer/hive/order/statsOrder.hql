...
-- 4. 创建function
create function currency_type_convert as 'com.jason.transformer.hive.CurrencyTypeDimensionUDF' using jar 'hdfs://localhost:8020/jason/transformer/transformer-0.0.1.jar';
create function payment_type_convert as 'com.jason.transformer.hive.PaymentTypeDimensionUDF' using jar 'hdfs://localhost:8020/jason/transformer/transformer-0.0.1.jar';
create function order_info as 'com.jason.transformer.hive.OrderInfoUDF' using jar 'hdfs://localhost:8020/jason/transformer/transformer-0.0.1.jar';
create function order_total_amount as 'com.jason.transformer.hive.OrderTotalAmountUDF' using jar 'hdfs://localhost:8020/jason/transformer/transformer-0.0.1.jar';
...
insert overwrite table order_info select oid,pl,s_time,cut,pt,cua 
	sqoop脚本
sqoop export --connect jdbc:mysql://localhost:3306/report --username hive --password hive --table order_info --export-dir /hive/bigdater.db/order_info/* --input-fields-terminated-by "\\01" --update-mode allowinsert --update-key order_id
...
-- 8. 订单数量sqoop(总的)
sqoop export --connect jdbc:mysql://localhost:3306/report --username hive --password hive --table stats_order --export-dir /hive/bigdater.db/stats_order_tmp2/* --input-fields-terminated-by "\\01" --update-mode allowinsert --update-key platform_dimension_id,date_dimension_id,currency_type_dimension_id,payment_type_dimension_id --columns platform_dimension_id,date_dimension_id,currency_type_dimension_id,payment_type_dimension_id,orders,created
